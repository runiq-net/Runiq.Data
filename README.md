...
- Grouped aggregation
- Joins
- Window functions with partition and ordering definitions: RowNumber, Rank, DenseRank, Lag, Lead, FirstValue, LastValue, partition Sum, partition Average, partition Min, partition Max
